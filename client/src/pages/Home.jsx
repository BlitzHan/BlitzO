    ...
    <div className="home-container">
      ...
      <div className="home-content">
        <div className="logo-section">
          ...
          <p className="subtitle">Online Uno Oyunu <span style={{fontSize: '0.8em', opacity: 0.7, marginLeft: '8px', background: 'rgba(255,215,0,0.2)', padding: '2px 6px', borderRadius: '4px'}}>v1.2</span></p>
        </div>
